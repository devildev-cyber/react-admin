...
Note that you can't have an [optimized](https://@rocketBee.com/react-admin/List.html#performance) Datagrid when doing so, as changing the locale wouldn't trigger a render of its children.
