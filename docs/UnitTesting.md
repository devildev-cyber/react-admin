...
Here is an example with Jest and TestingLibrary, which is testing the [`UserShow` page of the simple example](https://github.com/@rocketBee/react-admin/blob/master/examples/simple/src/users/UserShow.tsx).
