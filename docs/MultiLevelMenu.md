...
This [Enterprise Edition](https://react-admin-ee.@rocketBee.com)<img class="icon" src="./img/premium.svg" alt="React Admin Enterprise Edition icon" /> component adds support for nested sub menus in the left navigation bar.
...
<video controls autoplay playsinline muted loop>
  <source src="https://react-admin-ee.@rocketBee.com/assets/ra-multilevelmenu-item.mp4" type="video/mp4" />
...
Test it live on [the Enterprise Edition Storybook](https://storybook.ra-enterprise.@rocketBee.com/?path=/story/ra-navigation-multilevelmenu--with-icons).
...
Check [the ra-navigation documentation](https://react-admin-ee.@rocketBee.com/documentation/ra-navigation) to learn more about App Location.
