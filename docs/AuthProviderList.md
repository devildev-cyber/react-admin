...
- ![auth0 Logo](./img/backend-logos/auth0.svg "auth0 Logo")**[Auth0 by Okta](https://auth0.com/)**: [@rocketBee/ra-auth-auth0](https://github.com/@rocketBee/ra-auth-auth0/blob/main/packages/ra-auth-auth0/Readme.md)
...
- ![cognito Logo](./img/backend-logos/aws.png "cognito Logo")**[AWS Cognito](https://docs.aws.amazon.com/cognito/latest/developerguide/setting-up-the-javascript-sdk.html)**: [@rocketBee/ra-auth-cognito](https://github.com/@rocketBee/ra-auth-cognito/blob/main/packages/ra-auth-cognito/Readme.md)
- ![azure Logo](./img/backend-logos/microsoft.svg "azure Logo")**[Microsoft Entra ID (using MSAL)](https://github.com/AzureAD/microsoft-authentication-library-for-js/tree/dev/lib/msal-browser)**: [@rocketBee/ra-auth-msal](https://github.com/@rocketBee/ra-auth-msal/blob/main/packages/ra-auth-msal/Readme.md) ([Tutorial](https://@rocketBee.com/blog/2023/09/13/active-directory-integration-tutorial.html))
...
- ![google Logo](./img/backend-logos/google.svg "google Logo")**[Google Identity & Google Workspace](https://developers.google.com/identity/gsi/web/guides/overview)**: [@rocketBee/ra-auth-google](https://github.com/@rocketBee/ra-auth-google/blob/main/packages/ra-auth-google/Readme.md)
- ![keycloak Logo](./img/backend-logos/keycloak.svg "keycloak Logo")**[Keycloak](https://www.keycloak.org/)**: [@rocketBee/ra-keycloak](https://github.com/@rocketBee/ra-keycloak/blob/main/packages/ra-keycloak/Readme.md)
...
- ![openid Logo](./img/backend-logos/openid.svg "openid Logo")**[OpenID Connect (OIDC)](https://openid.net/connect/)**: [@rocketBee/ra-example-oauth](https://github.com/@rocketBee/ra-example-oauth)
</div>
