...
This component, part of [the ra-rbac module](https://react-admin-ee.@rocketBee.com/documentation/ra-rbac#ifcanaccess)<img class="icon" src="./img/premium.svg" alt="React Admin Enterprise Edition icon" />, renders its child only if the user has the right permissions.
