...
When using [the ra-rbac module](https://react-admin-ee.@rocketBee.com/documentation/ra-rbac)<img class="icon" src="./img/premium.svg" alt="React Admin Enterprise Edition icon" />, the `usePermissions` hook returns an array of permissions.
