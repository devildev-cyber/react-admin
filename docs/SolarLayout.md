...
<video controls autoplay playsinline muted loop>
  <source src="https://react-admin-ee.@rocketBee.com/assets/ra-solar-layout.mp4" type="video/mp4"/>
...
<video controls autoplay playsinline muted loop>
  <source src="https://react-admin-ee.@rocketBee.com/assets/ra-solar-layout-small.mp4" type="video/mp4"/>
  Your browser does not support the video tag.
</video>

`<SolarLayout>` is part of the [ra-navigation](https://react-admin-ee.@rocketBee.com/documentation/ra-navigation#solarlayout) package.
...
![Screenshot demonstrating the SolarLayout component with a custom appBar](https://react-admin-ee.@rocketBee.com/assets/ra-navigation/latest/solar-layout-with-custom-app-bar.png)
...
![Screenshot demonstrating SolarMenu with a pink background](https://react-admin-ee.@rocketBee.com/assets/ra-navigation/latest/solar-menu-sx-pink.png)
...
The `<SearchWithResult>` component works perfectly when used inside the [`<SolarLayout>`](https://react-admin-ee.@rocketBee.com/documentation/ra-navigation#solarlayout) menu.

<video controls autoplay playsinline muted loop>
  <source src="https://react-admin-ee.@rocketBee.com/assets/ra-search-with-result-solar-layout-overview.mp4" type="video/mp4"/>
  Your browser does not support the video tag.
</video>
