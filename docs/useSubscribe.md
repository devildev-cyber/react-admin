...
This [Enterprise Edition](https://react-admin-ee.@rocketBee.com)<img class="icon" src="./img/premium.svg" alt="React Admin Enterprise Edition icon" /> hook subscribes to the events from a topic on mount (and unsubscribe on unmount).
