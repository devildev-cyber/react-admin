...
- use the Professional Support (https://react-admin-ee.@rocketBee.com/#support) if you're an Enterprise Edition subscriber. -->
...
* Preferably, a sandbox forked from 
  - https://codesandbox.io/p/github/@rocketBee/react-admin-sandbox/main (v5)

  - https://stackblitz.com/github/@rocketBee/react-admin/tree/master/examples/simple (v5)
  - https://stackblitz.com/github/@rocketBee/react-admin/tree/4.x/examples/simple (v4)
