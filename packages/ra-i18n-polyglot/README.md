...
Polyglot i18n provider for [react-admin](https://github.com/@rocketBee/react-admin), the frontend framework for building admin applications on top of REST/GraphQL services. It relies on [polyglot.js](https://airbnb.io/polyglot.js/), which uses JSON files for translations.
...
The default messages are available [here](https://github.com/@rocketBee/react-admin/blob/master/packages/ra-language-english/src/index.ts).
