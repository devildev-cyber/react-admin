...
This is the application we use for our end-to-end tests, and for reproducing bugs via [Stackblitz](https://stackblitz.com/github/@rocketBee/react-admin/tree/master/examples/simple).
